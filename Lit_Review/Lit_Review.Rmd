...
Overall I recommend not using London or Miyazaki data until alternate data sources are found. These locations have  too much missing data to be used. London also has faulty data and only one stations in which data is coming from. 
...
Currently checking Bronx highs
